/*file name: cdrv_dynamic.c
 * Description: This is the skeleton module of the chardriver with dynamic allocation of  major and with 2 minor numbers -- Char driver registration.
 * Data structures : 
 ...
 * 5. Create two files with mknod
 *
 * */

/* all we changed is the increasing the count to 2 insted of 1 so that the driver can be used for multiple devices.
 */
...
#define MAJORNO 190
#define MINORNO 0
#define COUNT 2 /*changed here*/
#define SUCCESS 0
#define FAIL -1
#define DRV_NAME "cdrv_dynamic"
